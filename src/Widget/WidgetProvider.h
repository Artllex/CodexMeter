...
struct WidgetProvider : winrt::implements<WidgetProvider,
    ...
    winrt::Microsoft::Windows::Widgets::Providers::IWidgetResourceProvider>
{
    ...
    void OnResourceRequested(winrt::Microsoft::Windows::Widgets::Providers::WidgetResourceRequestedArgs args);
    /* IWidgetProvider required functions that need to be implemented */
